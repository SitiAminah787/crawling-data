...
consumer_key = 'n5IaJcDpkVBLWcDwpizcgFCkF'
consumer_secret = 'DUt2MZICzXASIgPCm0WljLvKpxV6OpBGQG7kZKUwGEz4e9a9g5'

qry='soekarno-hatta' #query yang akan di cari
...
fName='soekarno-hatta.json' # Nama File hasil Crawling
